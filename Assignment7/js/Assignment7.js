...
function ShowSection(sectionName){
	...
	if(sectionName == 'deviceInfo') {
		var contactList = document.getElementById('deviceInfo');
		DisplaySectionTitle();
		document.getElementById('backButton').style.display = 'block';
		}
	if(sectionName == 'vibrate') {
		var contactList = document.getElementById('vibrate');
		DisplaySectionTitle();
		document.getElementById('backButton').style.display = 'block';
		}
}
...
//Assignment 6 - Camera and Contacts
...
//Assignment 7 - device information

function deviceInfo() {
	var model = device.model;
	var string = device.platform;
	document.getElementById("deviceInfoModel").innerHTML = model;
	document.getElementById("deviceInfoPlatform").innerHTML = string;
}

function vibrate(){
	navigator.vibrate(1000, 1000, 1000, 3000, 5000);	
}
